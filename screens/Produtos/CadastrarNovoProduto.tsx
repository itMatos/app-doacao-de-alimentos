...
export default function CadastrarNovoProduto({ navigation }: { navigation: any }) {
    ...
    const [successRegisterNewProduct, setSuccessRegisterNewProduct] = useState(false);
    ...
    const handleClickRegisterNewProduct = () => {
        setSuccessRegisterNewProduct(false);
        setFormData({
            nome_sem_acento: '',
            gtin: '',
            id_produto_categoria: 'Arroz',
    ...
    const createProduct = async () => {
        ...
        try {
            ...
            setSuccessRegisterNewProduct(true);
        } catch (error) {
                    ...
                    <View style={styles.content}>
                        ...
                        >
                            ...
                            <Button
                                icon={'camera'}
                                mode="contained"
                                onPress={() => handleClickRegisterNewProduct()}
                            ...
                            <View style={{ flex: 1 }}>
                                <View style={styles.inputGroup}>
                                    ...
                                    <TextInput
                                        ...
                                        dense
                                        right={
                                            <TextInput.Icon icon="camera" onPress={openCamera} />
                                        }
                                    />
                                </View>
                                ...
                                <View style={styles.inputGroup}>
                                    ...
                                    <TextInput
                                        error={
                                            formData.medida_por_embalagem.trim() === '' &&
                                            inputError
                                        }
                                        mode="outlined"
